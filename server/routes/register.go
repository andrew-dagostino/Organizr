...
func createMember(params *models.RegisterRequest) error {
...
func validateRegisterData(params *models.RegisterRequest) error {
...
func cleanRegisterData(params *models.RegisterRequest) {
